...
HT.Grid.prototype.GetHexByCoOrds = function(x, y) {
	var result = this.Hexes.filter(function(h) {
		return h.PathCoOrdX == x && h.PathCoOrdY == y;
	});
...
HT.Grid.prototype.draw = function(context) {
	this.Hexes.forEach(function(h) {h.draw(context);});
}